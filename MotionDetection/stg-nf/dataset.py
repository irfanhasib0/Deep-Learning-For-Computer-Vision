...
class PoseSegDataset(Dataset):
    ...
    def __init__(self, path_to_json_dir, path_to_vid_dir=None, normalize_pose_segs=True, return_indices=False,
                 return_metadata=False, debug=False, evaluate=False, abnormal_train_path=None,
                 **dataset_args):
        super().__init__()
        ...
        self.segs_data_np, self.segs_meta, self.segs_score_np = \
            gen_dataset(path_to_json_dir, num_clips=num_clips, ret_keys=True, **dataset_args)
