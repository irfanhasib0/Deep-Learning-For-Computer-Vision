...
from yolo_v8.data.augment import Format
from yolo_v8.data.dataset import YOLODataset
from yolo_v8.data.utils import check_det_dataset
from yolo_v8.models.yolo.model import YOLO
from yolo_v8.utils import LOGGER, USER_CONFIG_DIR, IterableSimpleNamespace, checks
...
class Explorer:
    def __init__(
        ...
        # Note duckdb==0.10.0 bug https://github.com/yolo_v8/yolo_v8/pull/8181
    ...
    def query(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.query(img='https://yolo_v8.com/images/zidane.jpg')
            ```
        """
    ...
    def get_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.get_similar(img='https://yolo_v8.com/images/zidane.jpg')
            ```
        """
        assert return_type in {
            "pandas",
    ...
    def plot_similar(
        ...
        Example:
            ...
            exp = Explorer()
            exp.create_embeddings_table()
            similar = exp.plot_similar(img='https://yolo_v8.com/images/zidane.jpg')
            ```
        """
