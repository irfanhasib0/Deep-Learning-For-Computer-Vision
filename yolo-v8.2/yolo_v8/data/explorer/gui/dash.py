...
from yolo_v8 import Explorer
from yolo_v8.utils import ROOT, SETTINGS
...
def utralytics_explorer_docs_callback():
    ...
    with st.container(border=True):
        st.image(
            "https://raw.githubusercontent.com/yolo_v8/assets/main/logo/Ultralytics_Logotype_Original.svg",
            width=100,
        )
        st.markdown(
            "<p>This demo is built using Ultralytics Explorer API. Visit <a href='https://docs.yolo_v8.com/datasets/explorer/'>API docs</a> to try examples & learn more</p>",
            unsafe_allow_html=True,
            help=None,
        )
        st.link_button("Ultrlaytics Explorer API", "https://docs.yolo_v8.com/datasets/explorer/")
