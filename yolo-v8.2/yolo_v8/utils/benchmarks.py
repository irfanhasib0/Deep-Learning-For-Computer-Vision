...
Usage:
    from yolo_v8.utils.benchmarks import ProfileModels, benchmark
...
from yolo_v8 import YOLO, YOLOWorld
from yolo_v8.cfg import TASK2DATA, TASK2METRIC
from yolo_v8.engine.exporter import export_formats
from yolo_v8.utils import ARM64, ASSETS, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from yolo_v8.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from yolo_v8.utils.files import file_size
...
class ProfileModels:
    ...
    Example:
        ```python
        from yolo_v8.utils.benchmarks import ProfileModels
