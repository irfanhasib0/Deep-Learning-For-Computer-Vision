...
from yolo_v8.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/yolo_v8/yolo_v8/pull/4674
    ...
    from yolo_v8.utils.torch_utils import de_parallel, torch
