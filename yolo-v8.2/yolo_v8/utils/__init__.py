...
HELP_MSG = """
    ...
    2. Use the Python SDK:
        ...
        results = model('https://yolo_v8.com/images/bus.jpg')  # predict on an image
        ...
        YOLOv8 'yolo' CLI commands use the following syntax:
            ...
            Where   TASK (optional) is one of [detect, segment, classify]
                    ...
                    ARGS (optional) are any number of custom 'arg=value' pairs like 'imgsz=320' that override defaults.
                        See all ARGS at https://docs.yolo_v8.com/usage/cfg or with 'yolo cfg'
    ...
    Community: https://community.yolo_v8.com
    GitHub: https://github.com/yolo_v8/yolo_v8
    """
...
class IterableSimpleNamespace(SimpleNamespace):
    ...
    def __getattr__(self, attr):
        ...
        raise AttributeError(
            f"""
            '{name}' object has no attribute '{attr}'. This may be caused by a modified or out of date yolo_v8
            'default.yaml' file.\nPlease update your code with 'pip install -U yolo_v8' and if necessary replace
            {DEFAULT_CFG_PATH} with the latest version from
            https://github.com/yolo_v8/yolo_v8/blob/main/yolo_v8/cfg/default.yaml
            """
        )
...
class ThreadingLocked:
    ...
    Example:
        ```python
        from yolo_v8.utils import ThreadingLocked
...
class SettingsManager(dict):
    ...
    def __init__(self, file=SETTINGS_YAML, version="0.0.4"):
        ...
        from yolo_v8.utils.checks import check_version
        from yolo_v8.utils.torch_utils import torch_distributed_zero_first
        ...
        with torch_distributed_zero_first(RANK):
            ...
            help_msg = (
                ...
                "For help see https://docs.yolo_v8.com/quickstart/#yolo_v8-settings."
            )
            if not (correct_keys and correct_types and correct_version):
                LOGGER.warning(
                    "WARNING ⚠️ Ultralytics settings reset to default values. This may be due to a possible problem "
                    f"with your settings or a recent yolo_v8 package update. {help_msg}"
                )
                self.reset()
...
def deprecation_warn(arg, new_arg, version=None):
    ...
    LOGGER.warning(
        f"WARNING ⚠️ '{arg}' is deprecated and will be removed in 'yolo_v8 {version}' in the future. "
