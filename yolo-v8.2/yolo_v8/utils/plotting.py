...
from yolo_v8.utils import LOGGER, TryExcept, ops, plt_settings, threaded
from yolo_v8.utils.checks import check_font, check_version, is_ascii
from yolo_v8.utils.files import increment_path


class Colors:
    """
    Ultralytics default color palette https://yolo_v8.com/.
...
@TryExcept()  # known issue https://github.com/yolo_v8/yolov5/issues/5395
@plt_settings()
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    """Plot training labels including class histograms and box statistics."""
    import pandas  # scope for faster 'import yolo_v8'
    import seaborn  # scope for faster 'import yolo_v8'
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from yolo_v8.utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/yolo_v8/yolov5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from yolo_v8.utils.plotting import plot_results
