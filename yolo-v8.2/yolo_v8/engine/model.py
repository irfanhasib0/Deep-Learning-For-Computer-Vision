...
from yolo_v8.cfg import TASK2DATA, get_cfg, get_save_dir
from yolo_v8.hub.utils import HUB_WEB_ROOT
from yolo_v8.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from yolo_v8.utils import (
    ARGV,
    ASSETS,
    DEFAULT_CFG_DICT,
    LOGGER,
...
class Model(nn.Module):
    ...
    def __init__(
        ...
        # Check if Ultralytics HUB model from https://hub.yolo_v8.com
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[yolo_v8.engine.results.Results]): A list of prediction results, encapsulated in the Results class.
        """
    ...
    def _get_hub_session(model: str):
        ...
        from yolo_v8.hub.session import HUBTrainingSession
    ...
    def is_hub_model(model: str) -> bool:
        ...
        return any(
            (
                model.startswith(f"{HUB_WEB_ROOT}/models/"),  # i.e. https://hub.yolo_v8.com/models/MODEL_ID
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (yolo_v8.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (yolo_v8.engine.model.Model): The instance of the class with loaded weights.
    ...
    def save(self, filename: Union[str, Path] = "saved_model.pt", use_dill=True) -> None:
        ...
        from yolo_v8 import __version__

        updates = {
            "date": datetime.now().isoformat(),
            "version": __version__,
            "license": "AGPL-3.0 License (https://yolo_v8.com/license)",
            "docs": "https://docs.yolo_v8.com",
        }
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("yolo_v8")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[yolo_v8.engine.results.Results]): A list of tracking results, encapsulated in the Results class.

        Raises:
            AttributeError: If the predictor does not have registered trackers.
        """
        if not hasattr(self.predictor, "trackers"):
            from yolo_v8.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the yolo_v8.utils.benchmarks module. The benchmarking is configured
        ...
        """
        self._check_is_pytorch_model()
        from yolo_v8.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the yolo_v8.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from yolo_v8.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the yolo_v8.nn.autobackend module.

        Returns:
            (list | None): The class names of the model if available, otherwise None.
        """
        from yolo_v8.nn.autobackend import check_class_names
