...
from yolo_v8.cfg import get_cfg
from yolo_v8.data.dataset import YOLODataset
from yolo_v8.data.utils import check_det_dataset
from yolo_v8.nn.autobackend import check_class_names, default_class_names
from yolo_v8.nn.modules import C2f, Detect, RTDETRDecoder
from yolo_v8.nn.tasks import DetectionModel, SegmentationModel, WorldModel
...
from yolo_v8.utils.checks import check_imgsz, check_is_path_safe, check_requirements, check_version
from yolo_v8.utils.downloads import attempt_download_asset, get_github_assets
from yolo_v8.utils.files import file_size, spaces_in_path
from yolo_v8.utils.ops import Profile
from yolo_v8.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode


def export_formats():
    """YOLOv8 export formats."""
    import pandas  # scope for faster 'import yolo_v8'
...
class Exporter:
    ...
    def __call__(self, model=None):
        ...
        if isinstance(model, WorldModel):
            LOGGER.warning(
                ...
                "See https://docs.yolo_v8.com/models/yolo-world for details."
            )
    ...
    def export_engine(self, prefix=colorstr("TensorRT:")):
        ...
        f_onnx, _ = self.export_onnx()  # run before trt import https://github.com/yolo_v8/yolo_v8/issues/7016
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/yolo_v8/yolo_v8/issues/5161",
        )
        import onnx2tf
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug https://github.com/yolo_v8/yolo_v8/issues/1185")
