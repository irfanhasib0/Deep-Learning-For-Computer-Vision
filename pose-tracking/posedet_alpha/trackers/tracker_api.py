...
class Tracker(object):
    def __init__(self,device='cuda'):
        ...
        self.nid = 1000
        self.arch = "osnet_ain" # "osnet" or "res50-fc512"
        self.loadmodel = "../models/pose/alpha_pose/osnet_ain_x1_0_msmt17_256x128_amsgrad_ep50_lr0.0015_coslr_b64_fb10_softmax_labsmth_flip_jitter.pth"
        self.frame_rate =  30
        ...
        #m = ResModel(n_ID=self.nid)
        if self.arch == "res50-fc512":
            m = resnet50_fc512(num_classes=1,pretrained=False)
        elif self.arch == "osnet_ain":
        ...
        self.model.eval()
        load_pretrained_weights(self.model,self.loadmodel)
        self.tracked_stracks = []  # type: list[STrack]
        self.lost_stracks = []  # type: list[STrack]
        self.removed_stracks = []  # type: list[STrack]

        self.frame_id = 0
        self.det_thresh = self.conf_thres
