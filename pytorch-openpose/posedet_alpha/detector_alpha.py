...
class Params():
    def __init__(self):                                        
        self.cfg           = 'posedet_alpha/configs/coco/resnet/256x192_res50_lr1e-3_1x.yaml'
        ...
        self.checkpoint    = '../models/pose/fast_res50_256x192_72AP.pth'
        self.detector      = 'yolo'
        self.image         = ''
        self.save_img      = False
        self.vis           = True
...
class DataWriter():
    ...
    def get_pose(self,boxes, scores, ids, hm_data, cropped_boxes, orig_img):
