...
class YOLODetector(BaseDetector):
    def __init__(self, cfg, opt=None):
        ...
        self.model_cfg = '../models/yolo-spp/yolov3-spp.cfg'
        self.model_weights = '../models/yolo-spp/yolov3-spp.weights'
            ...
            for cls in img_classes:
                ...
                if nms:
                    if platform.system() != 'Windows':
                        ...
                        inds = nms(image_pred_class[:,:4],image_pred_class[:,4],nms_conf)
