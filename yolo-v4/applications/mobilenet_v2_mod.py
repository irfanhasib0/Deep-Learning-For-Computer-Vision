...
class MobileNetV2(tf.keras.Model):
    def __init__(self,input_shape=None,
        ...
        self.conv_lobj_1 = layers.Conv2D(filters=16*self.NH, kernel_size = 3, strides=1,
        ...
        self.conv_lobj_2 = layers.Conv2D(filters=3*(NUM_CLASS + 5), kernel_size = 1, strides=1,
                          padding='same', use_bias=False, kernel_regularizer=l2(0.0005),
                          kernel_initializer=tf.random_normal_initializer(stddev=0.01),
        ...
        if 'medium' in self.obj_scales:
            self.conv_mobj_1 = layers.Conv2D(filters=4*self.NH, kernel_size = 1, strides=1,
                              padding='same', use_bias=False, kernel_regularizer=l2(0.0005),
                              kernel_initializer=tf.random_normal_initializer(stddev=0.01),
            ...
            self.ups_mobj_1 = layers.Conv2DTranspose(4*self.NH,(3,3),strides =(2,2),padding='same')
            #conv = self.upsample(conv)
            self.concat_mobj_1 = layers.concatenate#([conv, route_2], axis=-1)

            self.conv_mobj_2 = layers.Conv2D(filters=16*self.NH, kernel_size = 3, strides=1,
                              padding='same', use_bias=False, kernel_regularizer=l2(0.0005),
                              kernel_initializer=tf.random_normal_initializer(stddev=0.01),
        ...
        if 'small' in self.obj_scales:
            self.conv_sobj_1 = layers.Conv2D(filters=4 * self.NH, kernel_size = 1, strides=1,
                              padding='same', use_bias=False, kernel_regularizer=l2(0.0005),
                              kernel_initializer=tf.random_normal_initializer(stddev=0.01),
            ...
            self.ups_sobj_1 =  layers.Conv2DTranspose(4*self.NH,(3,3),strides =(2,2),padding='same')
            #conv = self.upsample(conv)
            self.concat_sobj_1 = layers.concatenate

            self.conv_sobj_2 = layers.Conv2D(filters=16*self.NH, kernel_size = 3, strides=1,
                              padding='same', use_bias=False, kernel_regularizer=l2(0.0005),
                              kernel_initializer=tf.random_normal_initializer(stddev=0.01),
