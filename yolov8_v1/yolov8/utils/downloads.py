...
# Define Ultralytics GitHub assets maintained at https://github.com/yolov8/assets
GITHUB_ASSETS_REPO = 'yolov8/assets'
...
def delete_dsstore(path, files_to_delete=('.DS_Store', '__MACOSX')):
    ...
    Example:
        ```python
        from yolov8.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress=True, exclude=('.DS_Store', '__MACOSX'), progress=True):
    ...
    Example:
        ```python
        from yolov8.utils.downloads import zip_directory
...
def unzip_file(file, path=None, exclude=('.DS_Store', '__MACOSX'), exist_ok=False, progress=True):
    ...
    Example:
        ```python
        from yolov8.utils.downloads import unzip_file
...
def check_disk_space(url='https://yolov8.com/assets/coco128.zip', sf=1.5, hard=True):
    """
    Check if there is sufficient disk space to download and store a file.

    Args:
        url (str, optional): The URL to the file. Defaults to 'https://yolov8.com/assets/coco128.zip'.
...
def get_google_drive_file_info(link):
    ...
    Example:
        ```python
        from yolov8.utils.downloads import get_google_drive_file_info
...
def safe_download(url,
    ...
    Example:
        ```python
        from yolov8.utils.downloads import safe_download

        link = "https://yolov8.com/assets/bus.jpg"
...
def get_github_assets(repo='yolov8/assets', version='latest', retry=False):
...
def attempt_download_asset(file, repo='yolov8/assets', release='v0.0.0'):
    """
