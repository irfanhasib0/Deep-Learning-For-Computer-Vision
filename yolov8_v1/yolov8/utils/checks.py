...
def parse_requirements(file_path=ROOT.parent / 'requirements.txt', package=''):
    ...
    Args:
        ...
        package (str, optional): Python package to use instead of requirements.txt file, i.e. package='yolov8'.
    ...
    Example:
        ```python
        from yolov8.utils.checks import parse_requirements

        parse_requirements(package='yolov8')
        ```
    """
...
def check_version(current: str = '0.0.0',
    ...
    if not current:  # if current is '' or None
        ...
        return True
    elif not current[0].isdigit():  # current is package name rather than version string, i.e. current='yolov8'
        try:
...
def check_latest_pypi_version(package_name='yolov8'):
    """
...
def check_pip_update_available():
    """
    Checks if a new version of the yolov8 package is available on PyPI.
    ...
    if ONLINE and is_pip_package():
        with contextlib.suppress(Exception):
            ...
            if check_version(__version__, f'<{latest}'):  # check if current version is < latest version
                LOGGER.info(f'New https://pypi.org/project/yolov8/{latest} available 😃 '
                            f"Update with 'pip install -U yolov8'")
                return True
    return False
...
def check_font(font='Arial.ttf'):
    ...
    url = f'https://yolov8.com/assets/{name}'
...
def check_requirements(requirements=ROOT.parent / 'requirements.txt', exclude=(), install=True, cmds=''):
    ...
    Example:
        ...
        check_requirements('yolov8>=8.0.0')

        # Check multiple packages
        check_requirements(['numpy', 'yolov8>=8.0.0'])
        ```
    """
        ...
        if 'u.yaml' in file:
            ...
            if file != original_file and verbose:
                LOGGER.info(
                    ...
                    f'trained with https://github.com/yolov8/yolov8 and feature improved performance vs '
                    f'standard YOLOv5 models trained with https://github.com/yolov8/yolov5.\n')
    return file
...
def collect_system_info():
    ...
    for r in parse_requirements(package='yolov8'):
        try:
...
def check_amp(model):
    ...
    Example:
        ...
        from yolov8.utils.checks import check_amp
    ...
    try:
        from yolov8 import YOLO
        assert amp_allclose(YOLO('../models/yolov8n.pt'), im)
