...
[arguments](https://docs.yolov8.com/usage/cfg/) as in the CLI example above:
...
Ultralytics supports many model architectures. Visit https://docs.yolov8.com/models to view detailed information and usage. Any of these models can be used by loading their configs or pretrained checkpoints if available.
...
To get started, please consult our [Contributing Guide](https://docs.yolov8.com/help/contributing) for step-by-step instructions on how to submit a Pull Request (PR) 🛠️. Your contributions are eagerly awaited!
